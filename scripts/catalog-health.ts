...
if (process.argv.includes('--json')) {
  ...
  console.log(`- ${health.totals.offers} offers across ${health.totals.providers} providers (${health.totals.directProviders} direct)`);
  ...
  console.log(`- source freshness: ${health.freshness.freshSources} fresh, ${health.freshness.agingSources} aging, ${health.freshness.staleSources} stale, ${health.freshness.unknownSources} unknown`);
