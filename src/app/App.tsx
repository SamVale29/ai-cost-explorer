  ...
  useEffect(() => {
    loadCatalog()
      ...
      .catch((reason: unknown) =>
        setError(reason instanceof Error ? reason.message : 'Catalog failed to load'),
      );
  }, []);
    ...
    return (
      <div className="fatal-state">
        <div>
          ...
          <p>{error}</p>
          <p>
            Run <code>pnpm data:build</code> before serving the app.
          </p>
        </div>
      </div>
    );
    ...
    <div className="app-shell">
      ...
      >
        <div className="brand-lockup">
          ...
          <div>
            <div className="brand-name">AI Cost Explorer</div>
            <div className="brand-kicker">PUBLIC BETA · v0.1.0</div>
          </div>
        </div>
        ...
        <div className="sidebar-bottom">
          <div className="data-health">
            ...
            <div>
              <strong>{catalog.offers.length} offers monitored</strong>
              <span>Data as of {formatDate(catalog.dataAsOf)}</span>
            </div>
          </div>
          <button
      ...
      <main id="main-content" className="main-content" tabIndex={-1}>
        <header className="topbar">
          ...
          <div className="topbar-actions">
            <span className="updated-label">
              ...
              Catalog checked {formatDate(catalog.dataAsOf)}
            </span>
            <button
        ...
        <footer className="site-footer">
          ...
          <span>
            ...
            <span className="footer-separator">·</span>MIT License
          </span>
        </footer>
      </main>
    </div>
  ...
  return (
    <>
      <section className="hero-panel">
        <div className="hero-copy">
          <div className="eyebrow">
            ...
            TRANSPARENT AI PRICING · PUBLIC BETA
          </div>
          <h1>
            Choose the right
            <br />
            <em>AI model</em> before the bill arrives.
          </h1>
          <p>
            Compare pricing, capabilities, context windows and verified sources across modern AI
            APIs. Then model the workload before you commit to a provider.
          </p>
          <div className="hero-actions">
            ...
            <Link className="button button-ghost" to="/calculator">
              Estimate your cost <BarChart3 size={16} />
            </Link>
          </div>
          <div className="hero-footnote">
            <ShieldCheck size={15} />
            <span>Independent data · Field-level provenance · No affiliate links</span>
          </div>
        </div>
        <div className="hero-visual">
          <div className="hero-visual-top">
            ...
            <span className="hero-status">
              <span className="pulse-dot" />
              updated {formatDate(catalog.dataAsOf)}
            </span>
          </div>
          <div className="mini-terminal">
            <div className="terminal-row terminal-header">
              <span>OFFER</span>
              <span>INPUT</span>
              <span>OUTPUT</span>
              <span>CONTEXT</span>
            </div>
            {preview.slice(0, 5).map((offer) => {
              const rule = standardRule({ offer });
              return (
                <div className="terminal-row" key={offer.id}>
                  <span>
                    <b>{offer.model.name}</b>
                    <small>{offer.provider.name.replace(' API', '')}</small>
                  </span>
                  <span className="price-mint">
                  ...
                  <span>
                    {offer.model.contextWindowTokens
                      ? formatCompactNumber(offer.model.contextWindowTokens)
                      : '—'}
                  </span>
                </div>
              );
      ...
      <section className="stats-grid">
        <StatCard
          label="Offers monitored"
          value={String(catalog.offers.length)}
          note="Across direct API providers"
          accent="mint"
          icon={<Table2 size={18} />}
        />
        <StatCard
          label="API providers"
          value={String(catalog.providers.length)}
          note="No reseller mixing"
          accent="blue"
          icon={<Zap size={18} />}
        />
        <StatCard
          label="Official sources"
          value={String(catalog.sources.length)}
          note="Linked at field level"
          accent="gold"
          icon={<ShieldCheck size={18} />}
        />
        <StatCard
          label="Freshly checked"
          value={`${fresh}/${offers.length}`}
          note={`${pricingEvents} initial history observations`}
          accent="purple"
      ...
      <section className="section-block">
        <div className="section-heading">
          <div>
            ...
            <h2>A sharper starting point than a price list.</h2>
          </div>
        ...
        <div className="table-card preview-card">
          <div className="preview-toolbar">
            ...
            <span className="toolbar-note">Standard token rates · USD / 1M tokens</span>
          </div>
          <div className="table-scroll">
            <table className="data-table preview-table">
              ...
              <tbody>
                {preview.map((offer) => (
                  <OfferTableRow key={offer.id} offer={offer} compact />
                ))}
              </tbody>
            </table>
          </div>
      ...
      <section className="split-section">
        <div className="info-card dark-card">
          ...
          <h2>Cost is a product decision, not a spreadsheet footnote.</h2>
          <p>
            Pricing is only one dimension. Context, modalities, tools, caching, batch discounts and
            observed performance can change which offer is actually economical for your workload.
          </p>
          <Link className="button button-small button-dark" to="/methodology">
            Read the methodology <ArrowRight size={14} />
          </Link>
        </div>
        <div className="info-card transparent-card">
          <div className="eyebrow">TRANSPARENT BY DESIGN</div>
          <div className="principle-list">
            <div>
              <CheckCircle2 size={18} />
              <span>
                <strong>Offer-level economics</strong>
                <small>Model, API provider and commercial offer are distinct entities.</small>
              </span>
            </div>
            <div>
              <CheckCircle2 size={18} />
              <span>
                <strong>Provenance, not confidence theater</strong>
                <small>Unknown fields stay unknown; every source is one click away.</small>
              </span>
            </div>
            <div>
              <CheckCircle2 size={18} />
              <span>
                <strong>Observed is not official</strong>
                <small>Benchmarks remain separate from provider specifications.</small>
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="cta-strip">
        <div>
          ...
          <h2>Help keep the catalog honest.</h2>
          <p>
            Suggest a provider, correct a price, or submit a reproducible benchmark. The data is
            versioned in GitHub for review.
          </p>
        </div>
        <div className="cta-actions">
          <a
            ...
            rel="noreferrer"
          >
            Open an issue <ExternalLink size={15} />
          </a>
          <Link className="button button-ghost" to="/methodology">
            How verification works <BookOpen size={15} />
          </Link>
        </div>
      </section>
  ...
  return (
    <tr className={selected ? 'row-selected' : ''}>
      <td className="model-cell">
        <div className="model-avatar">{offer.model.name.slice(0, 1)}</div>
        <div>
          ...
          <Badge
            tone={
              offer.availability.status === 'active'
                ? 'mint'
                : offer.availability.status === 'preview'
                  ? 'gold'
                  : 'danger'
            }
          >
...
function ExplorerPage() {
  ...
  const capabilityOptions = [
    ...
    { id: 'promptCaching', label: 'Prompt caching' },
    { id: 'batchApi', label: 'Batch API' },
  ...
  const filtered = useMemo(
    () =>
      offers.filter((offer) => {
        const rule = standardRule({ offer });
        const haystack =
          `${offer.model.name} ${offer.apiModelId} ${offer.provider.name} ${offer.organization.name}`.toLowerCase();
        ...
        if (
          ...
          (rule?.inputPrice === null ||
            rule?.inputPrice === undefined ||
            rule.inputPrice < filters.minInput)
        )
          return false;
        if (
          ...
          (rule?.inputPrice === null ||
            rule?.inputPrice === undefined ||
            rule.inputPrice > filters.maxInput)
        )
          return false;
        if (
          filters.minOutput !== undefined &&
          (rule?.outputPrice === null ||
            rule?.outputPrice === undefined ||
            rule.outputPrice < filters.minOutput)
        )
          return false;
        if (
          ...
          (rule?.outputPrice === null ||
            rule?.outputPrice === undefined ||
            rule.outputPrice > filters.maxOutput)
        )
          return false;
        if (
          filters.minContext !== undefined &&
          (offer.model.contextWindowTokens === null ||
            offer.model.contextWindowTokens === undefined ||
            offer.model.contextWindowTokens < filters.minContext)
        )
          return false;
        return true;
      }),
  ...
  const sorted = [...filtered].sort((a, b) => {
    const get = (offer: OfferView) => {
      const rule = standardRule({ offer });
      if (sort.key === 'output') return rule?.outputPrice ?? Infinity;
      if (sort.key === 'context') return offer.model.contextWindowTokens ?? -1;
      if (sort.key === 'provider') return offer.provider.name;
      if (sort.key === 'status') return offer.availability.status;
      return rule?.inputPrice ?? Infinity;
    };
    const av = get(a);
    const bv = get(b);
    const comparison =
  ...
  const updateFilter = <K extends keyof ExplorerUrlState>(key: K, value: ExplorerUrlState[K]) =>
  ...
  const activeFilterCount =
    ...
    [
      ...
      filters.maxOutput,
      filters.minContext,
    ].filter((value) => value !== undefined && value !== '' && value !== false).length;
  const exportRows = sorted.map((offer) => {
    const rule = standardRule({ offer });
    return {
      offerId: offer.id,
      ...
      inputPriceUsdPerMillion: rule?.inputPrice ?? null,
  ...
  const shareCompare = () => {
    if (selected.length) navigate(`/compare?compare=${selected.join(',')}`);
  };
  return (
    <>
      <PageHeader
        ...
        <section className="explorer-main">
          <div className="active-filters">
            <span className="result-count" aria-live="polite">
              <strong>{sorted.length}</strong> of {offers.length} offers
            </span>
            {activeFilterCount > 0 && (
              <>
                {filters.search && (
                ...
                {filters.providers.map((provider) => (
                  <FilterChip
                    key={provider}
                    label={catalog.providers.find((item) => item.id === provider)?.name ?? provider}
                    onRemove={() =>
                      updateFilter(
                        'providers',
                ...
                {filters.capabilities.map((capability) => (
                  <FilterChip
                    key={capability}
                    label={
                      capabilityOptions.find((item) => item.id === capability)?.label ?? capability
                    }
                    onRemove={() =>
                      updateFilter(
                        'capabilities',
          ...
          <div className="table-card explorer-table-card">
            <div className="table-toolbar">
              ...
              <div className="toolbar-right">
                <span className="density-label">{selected.length}/4 selected</span>
                {selected.length >= 2 && (
                  <button
            ...
            <div className="table-scroll">
              <table className="data-table explorer-table">
                <caption className="sr-only">Searchable AI model offers</caption>
                <thead>
                  <tr>
                    <th>Model</th>
                    <SortableHeader
                    ...
                    <SortableHeader
                      ...
                      setSort={setSort}
                    />
                    <SortableHeader label="Output" sortKey="output" sort={sort} setSort={setSort} />
                    <SortableHeader
                      label="Context"
                      sortKey="context"
                      sort={sort}
            ...
            {sorted.length === 0 && (
              <EmptyState
                ...
                description="Clear a filter or broaden the price and context ranges to see more verified data."
                action={
                  <button
      ...
      {selected.length >= 2 && (
        <div className="compare-dock">
          <div>
            ...
            <span>
              <strong>{selected.length} offers ready</strong>
              <small>Side-by-side comparison is shareable</small>
            </span>
          </div>
          ...
          <button className="button button-primary" onClick={shareCompare}>
  ...
  return (
    <th aria-sort={active ? (sort.direction === 'asc' ? 'ascending' : 'descending') : 'none'}>
      <button
        ...
        type="button"
        onClick={() =>
          setSort({ key: sortKey, direction: active && sort.direction === 'asc' ? 'desc' : 'asc' })
        }
...
function ComparePage() {
  ...
  const selected = ids
    .map((id) => findOffer(offers, id))
    .filter((offer): offer is OfferView => Boolean(offer))
    .slice(0, 4);
  const copyLink = async () => {
    const link = window.location.href;
    if (navigator.clipboard) await navigator.clipboard.writeText(link);
    else window.prompt('Copy comparison URL', link);
  };
  const downloadComparison = () =>
    downloadText(
      'ai-cost-explorer-comparison.json',
      JSON.stringify(
        selected.map((offer) => ({
          id: offer.id,
          model: offer.model.name,
  ...
  if (selected.length < 2)
    return (
      <>
        <PageHeader
          eyebrow="WORKSPACE / COMPARE"
          title="Comparison workspace"
          description="Select two to four offers from the explorer to see the differences that matter."
          actions={
            <Link className="button button-primary" to="/explore">
              Choose offers <ArrowRight size={16} />
            </Link>
          }
        />
        <EmptyState
          title="Your comparison is empty"
          description="The comparison URL keeps selections shareable. Start from the model explorer."
          action={
    ...
    <>
      ...
      <div className="comparison-controls">
        <div className="compare-selected-list">
          {selected.map((offer) => (
            <div key={offer.id} className="compare-offer-chip">
              <span className="model-avatar small-avatar">{offer.model.name.slice(0, 1)}</span>
              <span>
              ...
              <button
                onClick={() =>
                  navigate(`/compare?compare=${ids.filter((id) => id !== offer.id).join(',')}`)
                }
                aria-label={`Remove ${offer.model.name}`}
              >
                <X size={14} />
              </button>
            </div>
      ...
      <div className="comparison-card table-card">
        ...
        >
          <div className="comparison-row comparison-head">
            ...
            {selected.map((offer) => (
              <div key={offer.id} className="comparison-offer-head">
                <Badge tone={offer.availability.status === 'active' ? 'mint' : 'gold'}>
                  {offer.availability.status}
                </Badge>
                <Link to={`/model/${offer.model.id}`}>
                  <strong>{offer.model.name}</strong>
                </Link>
          ...
          <div className="comparison-row comparison-sources">
            ...
            {selected.map((offer) => (
              <div className="comparison-value" key={offer.id}>
                <SourceList sources={offer.sources} compact />
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="compare-note">
        <CircleHelp size={16} />
        <span>
          “Not verified” means the field was not confirmed in the linked official source. It is not
          a quality score.
        </span>
      </div>
    </>
  ...
  return (
    <section className="scenario-shelf table-card" aria-labelledby="saved-scenarios-title">
      ...
      <div className="scenario-tools">
        ...
        <button className="button button-ghost button-small" type="button" onClick={onShare}>
          <Share2 size={14} />
          Copy share link
        </button>
        <button className="button button-ghost button-small" type="button" onClick={onExport}>
          <Download size={14} />
          Export JSON
        </button>
        <label className="button button-ghost button-small scenario-file-button">
          <Upload size={14} />
          Import JSON
      ...
      {scenarios.length > 0 ? (
        <div className="scenario-list">
          {scenarios.map((scenario) => (
            <article className="scenario-item" key={scenario.id}>
              <div>
                <strong>{scenario.name}</strong>
                <small>
                  {formatDate(scenario.savedAt)} · {scenario.selectedOfferIds.length} offers ·{' '}
                  {scenario.mode}
                </small>
              </div>
        ...
        <p className="scenario-empty">
          No saved scenarios yet. Name the current workload above to keep it.
        </p>
      )}
    </section>
  );
...
function CalculatorGuardrails({ messages }: { messages: string[] }) {
  ...
  return (
    <div className="calculator-validation" role="status">
      <CircleHelp size={16} />
      <ul>
...
function CalculatorPage() {
  ...
  const duplicateScenario = (scenario: SavedScenario) => {
    const duplicate: SavedScenario = {
      ...
      selectedOfferIds: [...scenario.selectedOfferIds],
    };
  ...
  const copyShareLink = async () => {
    ...
    try {
      ...
      else window.prompt('Copy this calculator link', shareUrl);
      setScenarioNotice('Share link copied.');
    } catch {
      window.prompt('Copy this calculator link', shareUrl);
      setScenarioNotice('Share link ready to copy.');
    }
  };
  const exportScenarios = () => {
    downloadText(
      'ai-cost-explorer-scenarios.json',
      serializeSavedScenarios(savedScenarios),
      'application/json',
    );
    setScenarioNotice('Scenarios exported.');
  };
  const importScenarios = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (!imported) {
        setScenarioNotice('Could not import that file.');
        return;
      }
  ...
  const inputFields: Array<{
    ...
    { key: 'inputTokens', label: 'Input tokens / request', suffix: 'tokens' },
    { key: 'outputTokens', label: 'Output tokens / request', suffix: 'tokens' },
    { key: 'cachedInputTokens', label: 'Cached input tokens', suffix: 'tokens' },
    { key: 'cacheWriteTokens', label: 'Cache-write tokens', suffix: 'tokens' },
    { key: 'requestsPerDay', label: 'Requests / day', suffix: 'req' },
    { key: 'daysPerMonth', label: 'Days / month', suffix: 'days' },
    { key: 'retryRate', label: 'Retry rate', suffix: '%', step: 0.01 },
    { key: 'batchRate', label: 'Batch share', suffix: '%', step: 0.01 },
  ];
  return (
    <>
      <PageHeader
      ...
      <div className="calculator-layout">
        <section className="calculator-form-card table-card">
          <div className="calculator-section-heading">
            <div>
              <span className="eyebrow">01 / WORKLOAD</span>
              <h2>Shape the scenario</h2>
            </div>
            ...
            {PRESETS.map((item) => (
              ...
              >
                <span className="preset-icon">
                  {item.id === 'custom' ? <Settings2 size={16} /> : <Sparkles size={16} />}
                </span>
                <span>
                  <strong>{item.label}</strong>
                  <small>{item.description}</small>
                </span>
                {preset === item.id && <CheckCircle2 className="preset-check" size={16} />}
              </button>
            ))}
          </div>
              ...
              <label key={field.key} className="number-field">
                ...
                <div>
                  <input
                    ...
                    value={
                      field.key === 'retryRate' || field.key === 'batchRate'
                        ? Number(input[field.key] ?? 0) * 100
                        : Number(input[field.key] ?? 0)
                    }
                    onChange={(event) => {
          ...
          <CalculatorGuardrails messages={validationMessages} />
        </section>
        <section className="offer-pick-card table-card">
          <div className="calculator-section-heading">
            <div>
      ...
      <section className="results-section">
        ...
        {results.length === 0 ? (
          <EmptyState
            title="Select at least one offer"
            description="Choose offers above to calculate the workload."
          />
        ) : (
          <>
                  ...
                  <div className={`result-card ${isCheapest ? 'best' : ''}`} key={result.offerId}>
                    ...
                    <div className="result-breakdown">
                      <span>
                        Input{' '}
                        <b>
                          {result.breakdown.standardInput === null
                            ? '—'
                            : formatCurrency(result.breakdown.standardInput, 4)}
                        </b>
                      </span>
                      <span>
                        Cache{' '}
                      ...
                      <span>
                        Output{' '}
                        <b>
                          {result.breakdown.output === null
                            ? '—'
                            : formatCurrency(result.breakdown.output, 4)}
                        </b>
                      </span>
                    </div>
            ...
            <div className="formula-card">
              <div>
                <span className="eyebrow">CALCULATION MEMORY</span>
                <h3>What the simulator applied</h3>
              </div>
              <code>
                standard input = (input − cached − writes) ÷ 1M × input rate
                <br />
                cached input = cached ÷ 1M × cache-hit rate
                <br />
                output = output ÷ 1M × output rate
                <br />
                {`monthly = request cost × requests/day × (1 + retry rate) × days/month`}
              </code>
              <span className="formula-note">
                Batch share is blended only where the offer publishes a batch rule. Long-context
                tiers switch when the request input crosses the provider threshold.
              </span>
            </div>
          </>
        )}
...
function HistoryPage() {
  ...
  const visible = catalog.history.filter((event) => {
  ...
  return (
    <>
      <PageHeader
        eyebrow="AUDIT TRAIL / HISTORY"
        title="Price history without invented lines."
        description="The chart starts at the first project observation. A detected date and an effective date are kept separate."
        actions={
          <Link className="button button-primary" to="/explore">
      ...
      />
      <div className="history-toolbar table-card">
        <div>
          <span className="toolbar-title">Filter observations</span>
          <span className="toolbar-note">
            Backfill is only added when an official dated source exists.
          </span>
        </div>
      ...
      <div className="history-honesty">
        <ShieldCheck size={18} />
        <div>
          <strong>What this history does not claim</strong>
          <p>
            These are project detection events, not a complete reconstruction of provider pricing
            history. Before the first observation, the chart is intentionally blank. The next update
            will be a reviewed data change, not a silent overwrite.
          </p>
        </div>
      </div>
    </>
...
function ValuePage() {
  const { offers } = useCatalog();
  const [xAxis, setXAxis] = useState<'input' | 'context'>('input');
  ...
  const getAxis = (offer: OfferView, axis: 'input' | 'context' | 'output') => {
    ...
    if (axis === 'output') return rule?.outputPrice ?? null;
    if (axis === 'context') return offer.model.contextWindowTokens ?? null;
    return null;
  };
  const raw = candidates
    .map((offer) => ({ offer, x: getAxis(offer, xAxis), y: getAxis(offer, yAxis) }))
    .filter(
  ...
  const points: ParetoPoint[] = raw.map((item) => ({
    ...
    y: yAxis === 'input' || yAxis === 'output' ? -item.y : item.y,
    dominated: false,
  }));
  ...
  return (
    <>
      <PageHeader
        eyebrow="DECISION SUPPORT / VALUE"
        title="Value is a frontier, not a winner."
        description="Plot two measurable dimensions, then inspect the non-dominated offers. Unknowns stay out of the frontier instead of receiving invented scores."
        actions={
          <Link className="button button-primary" to="/calculator">
            Simulate a workload <BarChart3 size={16} />
          </Link>
        }
      />
      <div className="value-controls table-card">
        <div className="axis-control">
          ...
          <label>
            ...
            <select
              value={yAxis}
              onChange={(event) => setYAxis(event.target.value as typeof yAxis)}
            >
              <option value="context">Context window</option>
            ...
            {[
              ...
              <label key={capability}>
                <input
                  ...
                  onChange={() => toggleRequired(capability)}
                />
                <span className="fake-check">
                  <Check size={12} />
                </span>
      ...
      <div className="value-layout">
        <section className="scatter-card table-card">
          <div className="chart-heading">
            <div>
            ...
            <div className="frontier-legend">
              ...
              <span>
                <i className="legend-swatch slate" />
                Other known
              </span>
            </div>
          </div>
          ...
          <div className="scatter-note">
            <Lightbulb size={15} />
            <span>
              A frontier depends on the axes, constraints and workload. It does not identify an
              absolute “best model.”
            </span>
          </div>
        </section>
        <section className="ranking-card table-card">
          <div className="chart-heading">
            <div>
              <span className="eyebrow">OPTIONAL RANKING</span>
              <h2>Transparent weights</h2>
            </div>
            <CircleHelp size={17} />
          </div>
          ...
          <div className="ranking-list">
            {rankings.map((item, index) => (
              <div className="ranking-item" key={item.offer.id}>
                <span className="ranking-index">{index + 1}</span>
                <span>
                  <strong>{item.offer.model.name}</strong>
                  <small>
                    {item.offer.provider.name} · {item.knownFields}/3 measurable fields
                  </small>
                </span>
...
function ModelPage() {
  ...
  return (
    <>
      <PageHeader
        eyebrow="CATALOG / MODEL DETAIL"
        title={model.name}
        description={`${model.family ?? 'Model'} · ${organization?.name ?? 'Organization'} · canonical model across its commercial offers.`}
        actions={
          <>
            <Link
              className="button button-ghost"
              to={`/compare?compare=${modelOffers
                .slice(0, 2)
                .map((offer) => offer.id)
                .join(',')}`}
            >
              Compare offers <ArrowDownUp size={16} />
            </Link>
            <a
              className="button button-primary"
              href={`${GITHUB_URL}/edit/main/data/models/index.json`}
              target="_blank"
              rel="noreferrer"
            >
              Edit data on GitHub <ExternalLink size={15} />
            </a>
          </>
        }
      />
      <div className="model-hero-card">
        <div className="model-detail-mark">{model.name.slice(0, 1)}</div>
        <div>
          <div className="model-detail-top">
            <Badge tone={model.status === 'active' ? 'mint' : 'gold'}>{model.status}</Badge>
            <StalenessBadge value={model.lastVerifiedAt} />
          </div>
          <h2>{model.name}</h2>
          <p>
        ...
        <div className="model-hero-stats">
          ...
          <div>
            <span>Verified</span>
            <strong>{formatDate(model.lastVerifiedAt)}</strong>
          </div>
        </div>
      </div>
      <div className="detail-grid">
        <section className="detail-card table-card">
          <div className="chart-heading">
            <div>
        ...
        <section className="detail-card table-card">
          <div className="chart-heading">
            <div>
              <span className="eyebrow">COMMERCIAL OFFERS</span>
              <h2>
                {modelOffers.length} provider{modelOffers.length === 1 ? '' : 's'}
              </h2>
            </div>
            <Table2 size={18} />
          </div>
            ...
            {modelOffers.map((offer) => {
              ...
              return (
                <div key={offer.id} className="offer-detail-row">
                  ...
                  <Link
                    to={`/compare?compare=${offer.id}`}
                    aria-label={`Compare ${offer.model.name} offer`}
                  >
                    <ArrowRight size={16} />
                  </Link>
                </div>
        ...
        <section className="detail-card table-card">
          ...
          <SourceList
            sources={modelOffers.flatMap((offer) => [...offer.sources, ...model.sources])}
          />
        </section>
        <section className="detail-card table-card">
          <div className="chart-heading">
            <div>
              <span className="eyebrow">HISTORY / BENCHMARKS</span>
              <h2>Evidence status</h2>
            </div>
            <History size={18} />
          </div>
          <p className="detail-copy">
            {catalog.history.filter((event) =>
              modelOffers.some((offer) => offer.id === event.offerId),
            ).length
              ? 'This model has a project observation in the price history.'
              : 'No historical price event has been recorded for this model yet.'}
          </p>
          <p className="detail-copy">
            {catalog.benchmarks.filter((benchmark) =>
              modelOffers.some((offer) => offer.id === benchmark.offerId),
            ).length
              ? 'Reproducible observed performance is available.'
              : 'No reproducible benchmark is published yet. Performance values are intentionally not estimated.'}
          </p>
        </section>
      </div>
    </>
  ...
  return (
    <>
      <PageHeader
        ...
        title="A public method for a private bill."
        description="AI Cost Explorer makes the assumptions behind a comparison inspectable, versioned and easy to challenge."
        actions={
          <a
            className="button button-primary"
            href={`${GITHUB_URL}/blob/main/docs/methodology.md`}
            target="_blank"
            rel="noreferrer"
          >
            Read on GitHub <ExternalLink size={15} />
          </a>
        }
      />
      <div className="methodology-layout">
        <aside className="methodology-nav">
          <a href="#entities">01 · Entities</a>
          <a href="#pricing">02 · Pricing</a>
          <a href="#history-method">03 · History</a>
          <a href="#benchmarks">04 · Benchmarks</a>
          <a href="#freshness">05 · Freshness</a>
          <a href="#limits">06 · Limits</a>
        </aside>
        <article className="prose-card">
          <section id="entities">
            <div className="eyebrow">01 / ENTITY MODEL</div>
            <h2>Model ≠ provider ≠ offer</h2>
            <p>
              A model is the canonical capability surface. A provider is the API company or platform
              that serves it. An offer is where commercial terms live: a provider, an API model ID
              and one or more pricing rules.
            </p>
            <div className="entity-flow">
              <span>
                MODEL<small>canonical model</small>
              </span>
              <ArrowRight size={17} />
              <span>
                PROVIDER<small>API surface</small>
              </span>
              <ArrowRight size={17} />
              <span className="highlight">
                OFFER<small>price + terms</small>
              </span>
            </div>
          </section>
          <section id="pricing">
            <div className="eyebrow">02 / TOKEN ECONOMICS</div>
            ...
            <div className="code-block">
              <code>
                ...
                <br />
                adjusted requests = base requests × (1 + retry rate)
                <br />
                monthly = request cost × requests/day × days/month
              </code>
            </div>
            <p>
              Batch is blended only across the chosen batch fraction. When a provider publishes a
              long-context threshold, the rule with the matching minimum or maximum input is
              selected. Missing prices produce “Not verified” and a warning.
            </p>
          </section>
          <section id="history-method">
            <div className="eyebrow">03 / AUDITABLE HISTORY</div>
            <h2>Start where the project starts.</h2>
            <p>
              The initial public beta includes project detection events dated{' '}
              {formatDate(catalog.dataAsOf)}. We do not draw a synthetic line before that point. A
              future update should include a reviewed diff with an official source and, when known,
              a separate effective date.
            </p>
          </section>
          <section id="benchmarks">
            <div className="eyebrow">04 / OBSERVED PERFORMANCE</div>
            <h2>Benchmarks are evidence, not specification.</h2>
            <p>
              Performance data is empty until it is measured under the documented protocol: two
              warmups, at least five measured repetitions, concurrency one for baseline, streaming
              for TTFT, P50/P95, region and UTC timestamp. CI never runs paid benchmarks
              automatically.
            </p>
            <Link className="text-link" to="/methodology#limits">
              See current limitations <ArrowRight size={14} />
            </Link>
          </section>
          <section id="freshness">
            <div className="eyebrow">05 / FRESHNESS</div>
            <h2>Staleness is a signal, not a deletion.</h2>
            <div className="freshness-grid">
              <div>
                <Badge tone="mint">Fresh</Badge>
                <span>0–30 days</span>
              </div>
              <div>
                <Badge tone="gold">Aging</Badge>
              ...
              <div>
                <Badge>Unknown</Badge>
                <span>No reliable date</span>
              </div>
            </div>
          </section>
          <section id="limits">
            <div className="eyebrow">06 / LIMITATIONS</div>
            <h2>What v0.1.0 does not pretend to know.</h2>
            <ul className="method-list">
              <li>Provider pricing can change outside the weekly watch window.</li>
              <li>“Not verified” is not a negative capability and should not be scored as one.</li>
              <li>
                Output rates and context limits may vary by endpoint, region, tier or contract.
              </li>
              <li>No performance benchmark is published in the beta dataset yet.</li>
              <li>
                Currency conversion and downstream infrastructure costs are intentionally out of
                scope.
              </li>
            </ul>
          </section>
      ...
      <div className="source-registry table-card">
        <div className="chart-heading">
          <div>
